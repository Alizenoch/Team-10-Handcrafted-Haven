...
export default function HeroSection() {
  return (
    <>
      <section className="relative w-full min-h-75 overflow-hidden">
        <Image
        ...
        <div className="relative z-10 mx-auto flex min-h-150 items-center px-6 py-24 md:px-16">
          <div className="max-w-3xl text-white">
            ...
            <p className="mt-6 text-lg md:text-xl text-indigo-100 leading-relaxed max-w-2xl">
              Explore a marketplace filled with unique, handcrafted items from passionate artisans
              worldwide.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-gray-100 p-2 rounded-lg shadow hover:shadow-lg transition">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">100% Handmade</h3>
              </div>
            ...
            <div className="bg-gray-100 p-3 rounded-lg shadow hover:shadow-lg transition">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-lg font-semibold text-gray-800">Global Artisans</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
